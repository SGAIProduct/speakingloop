...
export const modelEnv = {
  ...
  // Free-tier quotas vary by model and account; no payment card is required.
  GEMINI_TEXT_MODEL_STRONG: process.env.GEMINI_TEXT_MODEL_STRONG || "gemini-3.6-flash",
  GEMINI_TEXT_MODEL_MID: process.env.GEMINI_TEXT_MODEL_MID || "gemini-3.6-flash",
  GEMINI_TEXT_MODEL_MINI: process.env.GEMINI_TEXT_MODEL_MINI || "gemini-3.5-flash-lite",
  GEMINI_TRANSCRIPTION_MODEL: process.env.GEMINI_TRANSCRIPTION_MODEL || "gemini-3.6-flash",
...
const modelKeysByProvider = {
  ...
  gemini: {
    ...
    live_transcription: "GEMINI_TRANSCRIPTION_MODEL",
